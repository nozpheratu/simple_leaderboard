...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { email: @result.email, name: @result.name, score: @result.score } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { email: @result.email, name: @result.name, score: @result.score } }
